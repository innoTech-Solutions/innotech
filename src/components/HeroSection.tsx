	...
	return (
		<div className="flex h-screen justify-center items-center">
			<motion.div
				...
				className="h-screen bg-[radial-gradient(circle,_rgba(0,107,125,1)_0%,_rgba(2,1,37,0)_43%)] absolute top-0 left-0 w-full"
			/>
			<div className=" flex justify-center items-center flex-col">
				<div className="flex flex-col gap-8 mb-8">
					<h1 className="text-6xl text-white relative z-10 text-center font-fjalla">
						Building Websites.
						<br /> Innovating <span className="text-sky-400">Solutions</span>.
					</h1>
